...
[System.Web.Services.WebServiceBindingAttribute(Name="Ideone_ServiceBinding", Namespace="http://ideone.com/api/1/service")]
public partial class Ideone_ServiceService : System.Web.Services.Protocols.SoapHttpClientProtocol {
    ...
    /// <remarks/>
    public System.IAsyncResult BegincreateSubmission(string user, string pass, string source_code, int language, string input, bool run, bool @private, System.AsyncCallback callback, object asyncState) {
    ...
    /// <remarks/>
    public void createSubmissionAsync(string user, string pass, string source_code, int language, string input, bool run, bool @private) {
        this.createSubmissionAsync(user, pass, source_code, language, input, run, @private, null);
    }
    
    /// <remarks/>
    public void createSubmissionAsync(string user, string pass, string source_code, int language, string input, bool run, bool @private, object userState) {
