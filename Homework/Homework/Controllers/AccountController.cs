    ...
    public class AccountController : Controller {
        ...
        public ActionResult Register( RegisterModel model ) {
            if( ModelState.IsValid ) {
                ...
                try {
                    ...
                    //WebSecurity.GetUserId(User.Identity.Name) intoarce -1 chiar daca a fost apelat WebSecurity.Login(...)
                    using( var db = new UsersContext() ) {
                        var user = db.UserProfiles.Where( a => a.UserName == model.UserName ).FirstOrDefault();
                        Session ["UserId"] = user.UserId;
                        Session ["LiceuId"] = model.selectedHighschool;
                    ...
                    using( var db = new HomeworkContext() ) {
                        ...
                        AccountUtil.registerUser( db, model, id );
                        db.SaveChanges();
                    }
        ...
        public ActionResult Manage( ManageMessageId? message ) {
            ...
            ViewBag.StatusMessage =
                message == ManageMessageId.ChangePasswordSuccess ? "Datele au fost salvate"
